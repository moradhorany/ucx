...
struct uct_mm_coll_ep {
    ...
    unsigned                tx_index;        /* TX actual reading location */
    unsigned                rx_read_index;   /* RX next reading location */
    unsigned                rx_done_index;   /* RX next disposable location */
...
// TODO: allocate aligned... see mm_coll_iface.h
