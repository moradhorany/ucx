...
//	Reg(const T *data   ) : r(data[0]) {}
	...
	inline Reg<T>      andl         (const Reg<T> v)                       const { return mipp::andl         <T>(r, v.r);         }
	inline Reg<T>      orl          (const Reg<T> v)                       const { return mipp::orl          <T>(r, v.r);         }
	inline Reg<T>      xorl         (const Reg<T> v)                       const { return mipp::xorl         <T>(r, v.r);         }
...
//	inline Reg<T>      acoth        ()                                     const { return mipp::acoth        <T>(r);              }
	...
	inline Reg<T>      andl         (const Reg<T> v)                       const { return mipp_scop::andl<T>( r, v.r);            }
	...
	inline Reg<T>      orl          (const Reg<T> v)                       const { return  r  || v.r;                             }
	inline Reg<T>      xorb         (const Reg<T> v)                       const { return mipp_scop::xorb<T>(r, v.r);             }
	inline Reg<T>      xorl         (const Reg<T> v)                       const { return mipp_scop::xorl<T>(r, v.r);             }
	...
	inline Reg<T>      andl         (const Msk<N<T>()> m)                  const { return this->andl (m.template toReg<T>().r); }
	inline Reg<T>      orl          (const Msk<N<T>()> m)                  const { return this->orl  (m.template toReg<T>().r); }
	inline Reg<T>      xorl         (const Msk<N<T>()> m)                  const { return this->xorl (m.template toReg<T>().r); }
...
public:
	...
	inline Msk<N> andl  (const Msk<N>   v) const { return mipp_scop::andl<msk>( m, v.m);                  }
	...
	inline Msk<N> orl   (const Msk<N>   v) const { return (msk)(m || v.m);                                }
	inline Msk<N> xorb  (const Msk<N>   v) const { return mipp_scop::xorb  <msk>(m, v.m);                 }
	inline Msk<N> xorl  (const Msk<N>   v) const { return mipp_scop::xorl  <msk>(m, v.m);                 }
	...
	template <typename T> inline Reg<T> andl  (const Reg<T> v)  const { return this->toReg<T>().andl (v); }
	...
	template <typename T> inline Reg<T> orl   (const Reg<T> v)  const { return this->toReg<T>().orl  (v); }
	template <typename T> inline Reg<T> xorb  (const Reg<T> v)  const { return this->toReg<T>().xorb (v); }
	template <typename T> inline Reg<T> xorl  (const Reg<T> v)  const { return this->toReg<T>().xorl (v); }
...
template <typename T> inline Reg<T>      andl         (const Reg<T> v1, const Reg<T> v2)                      { return v1.andl(v2);              }
template <int      N> inline Msk<N>      andl         (const Msk<N> v1, const Msk<N> v2)                      { return v1.andl(v2);              }
template <typename T> inline Reg<T>      andl         (const Reg<T> v1, const Msk<N<T>()> v2)                 { return v1.andl(v2);              }
template <typename T> inline Reg<T>      andl         (const Msk<N<T>()> v1, const Reg<T> v2)                 { return v1.andl(v2);              }
template <typename T> inline Reg<T>      orl          (const Reg<T> v1, const Reg<T> v2)                      { return v1.orl(v2);               }
template <int      N> inline Msk<N>      orl          (const Msk<N> v1, const Msk<N> v2)                      { return v1.orl(v2);               }
template <typename T> inline Reg<T>      orl          (const Reg<T> v1, const Msk<N<T>()> v2)                 { return v1.orl(v2);               }
template <typename T> inline Reg<T>      orl          (const Msk<N<T>()> v1, const Reg<T> v2)                 { return v1.orl(v2);               }
template <typename T> inline Reg<T>      xorl         (const Reg<T> v1, const Reg<T> v2)                      { return v1.xorl(v2);              }
template <int      N> inline Msk<N>      xorl         (const Msk<N> v1, const Msk<N> v2)                      { return v1.xorl(v2);              }
template <typename T> inline Reg<T>      xorl         (const Reg<T> v1, const Msk<N<T>()> v2)                 { return v1.xorl(v2);              }
template <typename T> inline Reg<T>      xorl         (const Msk<N<T>()> v1, const Reg<T> v2)                 { return v1.xorl(v2);              }
