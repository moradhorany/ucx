...
template <typename T> inline T      andl(const T      val1, const T      val2) { return                                          val1  &&                      val2;   }
template <          > inline double andl(const double val1, const double val2) { return static_cast<double>(static_cast<int64_t>(val1) && static_cast<int64_t>(val2)); }
template <          > inline float  andl(const float  val1, const float  val2) { return static_cast<float >(static_cast<int32_t>(val1) && static_cast<int32_t>(val2)); }
...
template <typename T> inline T      xorl(const T      val1, const T      val2) { return                                          val1  ^^                      val2;   }
template <          > inline double xorl(const double val1, const double val2) { return static_cast<double>(static_cast<int64_t>(val1) ^^ static_cast<int64_t>(val2)); }
template <          > inline float  xorl(const float  val1, const float  val2) { return static_cast<float >(static_cast<int32_t>(val1) ^^ static_cast<int32_t>(val2)); }
